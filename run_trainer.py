...
from base_trainer import BaseEntry, build_base_trainer
...
FLAG_LIST = [
    ...
    flags_core.Flag("dtype", dtype=flags_core.Flag.TYPE.STRING, default="float16",
                    help="The computation type of the whole models."),
    ...
    flags_core.ModuleFlag(CtnmtModel.REGISTRY_NAME, help="The dataset."),
...
def _main(_):
    ...
    args, remaining_argv = flags_core.extend_define_and_parse(
        BaseEntry.REGISTRY_NAME, args, remaining_argv)
